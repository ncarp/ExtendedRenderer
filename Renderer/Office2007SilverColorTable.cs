...
namespace Office2007Renderer
{
    ...
    /// </summary>
    public class Office2007SilverColorTable : ProfessionalColorTable
	{
        ...
        protected override void InitColors(ref Dictionary<ProfessionalColorTable.KnownColors, Color> rgbTable)
        {
            ...
            rgbTable[KnownColors.ToolStripContentPanelGradientEnd] = Color.FromArgb(207, 211, 220); Color.FromArgb(155, 159, 166);
