...
namespace Office2007Renderer
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        private static ProfessionalColorTable ColorTables;
        public Office2007Renderer(ProfessionalColorTable ColorTable)
            : base(ColorTable)
        {
                ...
                (e.ToolStrip is ToolStripDropDownMenu))
            {
                ...
                else
                {
                    ...
                    if ((e.ToolStrip is MenuStrip) && !e.Item.Pressed && !e.Item.Selected)
                        e.TextColor = ColorTables.MenuItemText;//_textMenuStripItem;
                    else if ((e.ToolStrip is StatusStrip) && !e.Item.Pressed && !e.Item.Selected)
                        e.TextColor = ColorTables.StatusStripText;//_textStatusStripItem;
                    else
                        e.TextColor = ColorTables.ContextMenuItemText;
                    }
                    else
                    {
                    if ((e.ToolStrip is MenuStrip) && !e.Item.Pressed && !e.Item.Selected)
