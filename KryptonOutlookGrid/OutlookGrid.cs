    ...
    public partial class KryptonOutlookGrid : KryptonDataGridView
    {
        ...
        private void ShowColumnHeaderContextMenu(int columnIndex)
        {
            ...
            if (_menuItems == null)
            {
                ...
                _menuSortAscending = new KryptonContextMenuItem("Sort Ascending", OnColumnSortAscending);
                _menuSortDescending = new KryptonContextMenuItem("Sort Descending", new EventHandler(OnColumnSortDescending));
                _menuClearSorting = new KryptonContextMenuItem("Clear Sorting", new EventHandler(OnColumnClearSorting));
                _menuSeparator1 = new KryptonContextMenuSeparator();
                _menuGroupByThisColumn = new KryptonContextMenuItem("Group", new EventHandler(OnGroupByThisColumn));
                _menuUngroupByThisColumn = new KryptonContextMenuItem("Ungroup", new EventHandler(OnUnGroupByThisColumn));
                _menuShowGroupBox = new KryptonContextMenuItem("Show Group Box", null, new EventHandler(OnShowGroupBox));
                _menuHideGroupBox = new KryptonContextMenuItem("Hide Group box", null, new EventHandler(OnHideGroupBox));
                _menuSeparator2 = new KryptonContextMenuSeparator();
                _menuBestFitColumn = new KryptonContextMenuItem("Best Fit", null, new EventHandler(OnBestFitColumn));
                _menuBestFitAllColumns = new KryptonContextMenuItem("Best Fit All", new EventHandler(OnBestFitAllColumns));
