...
{
    using AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll;
    ...
    public class ScrollSkin : Panel
    {
        ...
        private AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.VScrollBar _VScrollBar1;

        [AccessedThroughProperty("HScrollBar1")]
        private AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.HScrollBar _HScrollBar1;
        ...
        internal virtual AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.VScrollBar VScrollBar1
        {
            get
            {
        ...
        internal virtual AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.HScrollBar HScrollBar1
        {
            get
            {
        ...
        {
            this.VScrollBar1 = new AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.VScrollBar();
            this.HScrollBar1 = new AC.ExtendedRenderer.Toolkit.ScrollBar.CustomScroll.HScrollBar();
