...
namespace AC.ExtendedRenderer.Toolkit.CalendarLibrary
{
    ...
    public partial class Calendar : DataGridView
    {
        ...
        public static ColorTable ct = new ColorTable();
        ...
        void item_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    AppointmentAdd AppAdd = new AppointmentAdd(ref cal);
                    AppAdd.ShowDialog();
                }
        ...
        void Calendar_ListChanged(string newList)
        {
        ...
        DataGridView.HitTestInfo _hitLast;
