...
namespace AC.ExtendedRenderer.Toolkit
{
    ...
    public class KryptonCalendar : CalendarLibrary.Calendar
    {
        ...
        private CalendarLibrary.ColorTable ColorTable = new CalendarLibrary.ColorTable();
