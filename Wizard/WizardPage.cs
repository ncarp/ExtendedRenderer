...
namespace AC.ExtendedRenderer.Toolkit.Wizard
{
	/// <summary>
	/// 
	/// </summary>
	[Designer(typeof(AC.ExtendedRenderer.Toolkit.Wizard.WizardPageDesigner))]
    public class WizardPage : ComponentFactory.Krypton.Toolkit.KryptonPanel
	{
