...
namespace AC.ExtendedRenderer.Toolkit.Drawing
{
	internal partial class Office2007MenuHelper
	{
		...
		{
			this.office2007ColorPlate1 = new AC.ExtendedRenderer.Toolkit.Drawing.Office2007ColorPlate();
			this.SuspendLayout();
			// 
			...
			this.office2007ColorPlate1.ColorPaletteSelected += new AC.ExtendedRenderer.Toolkit.Drawing.Office2007ColorPlate.ColorPaletteSelectedHandler(this.office2007ColorPlate1_ColorPaletteSelected);
			// 
