...
namespace AC.ExtendedRenderer.Navigator
{
    ...
    [System.Drawing.ToolboxBitmapAttribute(typeof(System.Windows.Forms.TableLayoutPanel))]
    public class OutlookBar : Control
    {
        ...
        private Color _GridColorDark;
        private Color _GridColorLight;
        ...
        private void FillButton(Rectangle rectangle, Graphics graphics, ButtonState buttonState, bool DrawTopBorder, bool DrawLeftBorder, bool DrawRightBorder)
        {
            ...
            //Draw Top Border...
            if (DrawTopBorder) graphics.DrawLine(new Pen(GetOutlookBarLineColor()), rectangle.X, rectangle.Y, rectangle.Width + rectangle.X, rectangle.Y);

            //DrawBorders?
            if (_DrawBorders)
            {
                //Draw Left Border...
                if (DrawLeftBorder) graphics.DrawLine(new Pen(GetOutlookBarLineColor()), rectangle.X, rectangle.Y, rectangle.X, rectangle.Y + rectangle.Height);
                //Draw Right Border...
                if (DrawRightBorder) graphics.DrawLine(new Pen(GetOutlookBarLineColor()), rectangle.X + rectangle.Width - 1, rectangle.Y, rectangle.X + rectangle.Width - 1, rectangle.Y + rectangle.Height);
            }
        }
        ...
        private void PaintGripRectangle(Graphics graphics)
        {
            ...
            {
                //Painted
                PaintGrip(graphics, RectangleIcon, _GridColorDark, _GridColorLight);
            }
            oIcon.Dispose();
        ...
        private void PaintDropDownRectangle(Graphics graphics)
        {
            ...
            {
                //paint the arrow
                PaintDropDown(graphics, RectangleIcon, _GridColorDark, _GridColorLight);
            }
            //Debug
        ...
        private Color GetButtonColor(ButtonState buttonstate, int colorIndex)
        {
            switch (this.Renderer)
            {
                ...
                case Renderer.Krypton:
                    ...
                    {
                        case ButtonState.Hovering | ButtonState.Selected:
                            if (colorIndex == 0) return this.ButtonColorSelectedAndHoveringTop;
                            if (colorIndex == 1) return this.ButtonColorSelectedAndHoveringBottom;
                            break;
                        case ButtonState.Hovering:
                            if (colorIndex == 0) return this.ButtonColorHoveringTop;
                            if (colorIndex == 1) return this.ButtonColorHoveringBottom;
                            break;
                        case ButtonState.Selected:
                            if (colorIndex == 0) return this.ButtonColorSelectedTop;
                            if (colorIndex == 1) return this.ButtonColorSelectedBottom;
                            break;
                        case ButtonState.Passive:
                            if (colorIndex == 0) return this.ButtonColorPassiveTop;
                            if (colorIndex == 1) return this.ButtonColorPassiveBottom;
                            break;
                    }
                    break;
                case Renderer.Custom:
        ...
        private void InitColors()
        {
            if (Renderer == Renderer.Krypton)
            {
                this._ButtonColorHoveringBottom = _palette.GetBackColor2(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Tracking);
                this._ButtonColorHoveringTop = _palette.GetBackColor1(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Tracking);

                this._ButtonColorSelectedBottom = _palette.GetBackColor2(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Pressed);
                this._ButtonColorSelectedTop = _palette.GetBackColor1(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Pressed);

                this._ButtonColorPassiveBottom = _palette.GetBackColor2(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Normal);
                this._ButtonColorPassiveTop = _palette.GetBackColor1(PaletteBackStyle.ButtonNavigatorStack, PaletteState.Normal);

                this._ButtonColorSelectedAndHoveringBottom = _palette.GetBackColor2(PaletteBackStyle.ButtonNavigatorStack, PaletteState.CheckedTracking);
                this._ButtonColorSelectedAndHoveringTop = _palette.GetBackColor1(PaletteBackStyle.ButtonNavigatorStack, PaletteState.CheckedTracking);

                this._OutlookBarLineColor = _palette.ColorTable.ToolStripBorder;

                this._ForeColorSelected = _palette.GetContentShortTextColor1(PaletteContentStyle.ButtonNavigatorStack, PaletteState.Pressed);//Color.Black;// _palette.ColorTable.MenuStripText;
                this.ForeColor = _palette.GetContentShortTextColor1(PaletteContentStyle.ButtonNavigatorStack, PaletteState.Normal);

                this._GridColorDark = _palette.ColorTable.GripDark;
                this._GridColorLight = _palette.ColorTable.GripLight;
            }
        }
