...
namespace AC.ExtendedRenderer.Navigator
{
	...
	public class KryptonTabControl : System.Windows.Forms.TabControl
	{
		...
		Color _buttonsBackColor = SystemColors.Control;
		...
		Color _buttonsBorderColor = SystemColors.ControlDark;
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(true), Category("Appearance-Extended")]
		...
		Color _tabColorDefaultLight = Color.FromArgb(194, 224, 255);
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(true), Category("Appearance-Extended")]
		...
		Color _tabColorDefaultDark = Color.FromArgb(194, 224, 255);
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(true), Category("Appearance-Extended")]
		...
		Color _tabForeColor = SystemColors.ControlText;
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(true), Category("Appearance-Extended")]
		...
		private void InitColors()
		{
			...
			this.TabColorHotDark = _paletteBack.GetBackColor1(PaletteState.Tracking); // Color.Gold; // 
			this.TabColorHotLight = _paletteBack.GetBackColor2(PaletteState.Tracking); // Color.LightGoldenrodYellow; // 

			this.TabColorSelectedDark = _paletteBack.GetBackColor1(PaletteState.Pressed);// _paletteBack.GetBackColor1(PaletteState.Pressed); // Color.FromArgb(252, 143, 61);//  
			this.TabColorSelectedLight = _paletteBack.GetBackColor2(PaletteState.Pressed);//= _paletteBack.GetBackColor2(PaletteState.Pressed); // Color.FromArgb(255, 224, 192);// 

			this.TabColorPressedDark = _paletteBack.GetBackColor1(PaletteState.CheckedTracking);// _paletteBack.GetBackColor1(PaletteState.Pressed); // Color.FromArgb(252, 143, 61);//  
			this.TabColorPressedLight = _paletteBack.GetBackColor2(PaletteState.CheckedTracking);//= _paletteBack.GetBackColor2(PaletteState.Pressed); // Color.FromArgb(255, 224, 192);// 

			if ((_preserveTabColor == false)) //to avoid black text on black tab
			{
				this.TabForeColor = _palette.ColorTable.StatusStripText;
				this.TabHotForeColor = _palette.ColorTable.MenuItemText;
				this.TabSelectedForeColor = _palette.ColorTable.MenuItemText;
			}
			else
			{
			...
			this.TabColorDefaultDark = _palette.ColorTable.ToolStripContentPanelGradientEnd;
