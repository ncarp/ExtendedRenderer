...
{
    [System.Drawing.ToolboxBitmapAttribute(typeof(System.Windows.Forms.TabControl)), ToolboxItem(false)]
    public class SystemTabControl: System.Windows.Forms.TabControl
    {
        ...
        public Color HotForColor
        {
            get { return _hotForeColor; }
            set { _hotForeColor = value; }
        }
        Color _globalBackColor;
        [Browsable(true), Category("Appearance-Extended")]
        public Color GlobalBackColor
        {
            get { return _globalBackColor; }
            set { _globalBackColor = value; }
        }
        ...
        public SystemTabControl()
        {
            ...
            if (_useKrypton)
            {
                _globalBackColor = _palette.ColorTable.ToolStripContentPanelGradientEnd;
                _backColor = _palette.ColorTable.ToolStripGradientMiddle;
                _hotForeColor = _palette.ColorTable.MenuStripText;
                if (_hotForeColor == Color.White) _hotForeColor = Color.DarkGray;
            }
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            if (!AC.ExtendedRenderer.Toolkit.Utils.Utility.IsVista())
            {
                TabArea.Y = TabArea.Y;
            ...
            if (_useKrypton)
            {
                g.FillRectangle(new SolidBrush(_globalBackColor), ClientRectangle);
            }
        ...
        #region ... Key Events ...
        private void KryptonTabControl_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
