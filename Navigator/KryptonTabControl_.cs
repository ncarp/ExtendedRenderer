...
namespace ComponentFactory.Krypton.Toolkit
{
    ...
    public class KryptonTabControl : TabControl
    {
        ...
        static Control g_ViewLayoutContextControl;
        static StringFormat g_StringFormat;
        static Font g_TabFontBold;
        static Font g_TabFontRegular;
        #endregion

        IPalette m_Palette;
        IRenderer m_Renderer;
        ViewLayoutContext m_ViewLayoutContext;

        PaletteMode m_PaletteMode;
        PaletteRedirect m_PaletteRedirect;
        PaletteBackInheritRedirect m_PaletteTabControlBackground;
        PaletteBorderInheritRedirect m_PaletteTabPageBorder;
        PaletteBackInheritRedirect m_PaletteTabButtonBackground;
        PaletteBorderInheritRedirect m_PaletteTabButtonBorder;

        IDisposable m_MementoTabButtonBackground;

        Boolean m_TransparentBackground = true;
        SolidBrush m_TabBrush;
        Font m_TabFont;
        ...
        protected override void OnPaintBackground(System.Windows.Forms.PaintEventArgs pevent)
        {
            ...
            {
                Color backColor = m_Palette.GetBackColor1(PanelBackStyle, PaletteState.Normal);
