...
{
    [System.Drawing.ToolboxBitmapAttribute(typeof(System.Windows.Forms.RichTextBox)), ToolboxItem(false)]
    public partial class WatermarkedRichTextBox : RichTextBox
    {
        ...
        [Category("Appearance-Extended")]
        [Browsable(true)]
        public Color WaterMarkFontColor
        {
        ...
        [Category("Appearance-Extended")]
        [Browsable(true)]
        public bool WaterMarkUsePaletteFontColor
        {
