...
namespace AC.StdControls.Toolkit.TView
{
    public class TreeViewPrintHelper
    {
        ...
        public void PrintPreviewTree(TreeView tree, string title, Font fnt)
        {
            this._title = title;
        ...
        public void PrintTree(TreeView tree, string title, Font fnt)
        {
            this._title = title;
            this.headerfont = new Font(FontFamily.GenericSansSerif, 16f, FontStyle.Bold, GraphicsUnit.Point);
            if (fnt != null)
