...
namespace AC.ExtendedRenderer.Toolkit.Charting
{
    ...
    public class KryptonKnobControl : System.Windows.Forms.UserControl
    {
        #region " constructor "
        ...
        public KryptonKnobControl()
        {
            ...
            DottedPen = new Pen(getDarkColor(_KnobBorderColor, 40));
        ...
        */
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            bKnob = new System.Drawing.Drawing2D.LinearGradientBrush(rKnob, getLightColor(KnobColor, 55), getDarkColor(KnobColor, 55), LinearGradientMode.ForwardDiagonal);
            // create LinearGradientBrush for knobPoint
            bKnobPoint = new System.Drawing.Drawing2D.LinearGradientBrush(rKnob, getLightColor(_KnobBorderColor, 55), getDarkColor(_KnobBorderColor, 55), LinearGradientMode.ForwardDiagonal);
        ...
        private void InitColors()
        {
            ...
            this.KnobColor = _palette.ColorTable.OverflowButtonGradientBegin;
            this.KnobBorderColor = _palette.ColorTable.ToolStripGradientBegin;
            this.ForeColor = _palette.ColorTable.MenuItemText;
            this.KnobBackColor = _palette.ColorTable.MenuStripGradientBegin;
        }
        #endregion
