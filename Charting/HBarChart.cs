...
{
    [System.Drawing.ToolboxBitmapAttribute(typeof(System.Diagnostics.PerformanceCounter))]
    public class HBarChart : UserControl
    {
        ...
        */
        ...
        private void DrawBar(Graphics gr, RectangleF rectBar, HBarData bar)
        {
            ...
            Color ColorBacklight = bar.Color;
            ...
            Color ColorFillBK = GetDarkerColor(bar.Color, 85);
            Color ColorBorder = GetDarkerColor(bar.Color, 100);
