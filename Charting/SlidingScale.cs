...
namespace AC.ExtendedRenderer.Toolkit.Charting
{
	...
	public partial class KryptonSlidingScale : UserControl
	{
        ...
        private void InitColors()
        {
            ...
            this.BorderColor = _palette.ColorTable.GripDark;
            this.ForeColor = _palette.ColorTable.StatusStripText;
            if(NeedleKryptonColor)this.needleColor = _palette.ColorTable.ButtonSelectedGradientEnd;
            this.ShadowColor = _palette.ColorTable.ToolStripGradientEnd;
        }
        ...
        private bool needleKryptonColor = false;
        /// <summary>
        /// The color of the scala needle.
        /// </summary>
        [
            Browsable(true),
            Category("Appearance"),
            Description("The using of the Krypton color for the scala needle."),
            DefaultValue(typeof(bool), "False")
        ]
        public bool NeedleKryptonColor
        {
            get { return needleKryptonColor; }
            set
            {
                if (value != needleKryptonColor)
                {
                    needleKryptonColor = value;
                    InitColors();
                    Invalidate();
                }
            }
